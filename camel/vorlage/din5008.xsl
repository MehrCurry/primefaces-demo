        ...
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="first-page" page-width="210mm" page-height="297mm" margin-left="25mm" margin-right="20mm" margin-bottom="3mm" margin-top="5mm">
                    <fo:region-body margin-bottom="30mm" margin-top="40mm"/>
            ...
            <fo:page-sequence master-reference="first-page">
                ...
                <fo:flow flow-name="xsl-region-body" font-family="Helvetica" font-size="10pt">
                    <fo:block>
                        <fo:table table-layout="fixed" width="100%" border-spacing="0mm" margin-top="18mm">
                            ...
                            <fo:table-body>
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:table table-layout="fixed" width="100%" border-spacing="0pt" margin-top="11mm" margin-left="2pt">
                                            <fo:table-column column-width="60%"/>
                                            <fo:table-column column-width="40%"/>
                        ...
                        <fo:block space-before="8mm">
                            <fo:table table-layout="fixed" width="100%" border-spacing="0pt" padding="3pt" font-size="10pt">
                                ...
                                <xsl:when test="$invoiceType = 'RG'">
                                    <xsl:choose>
                                        ...
                                        <xsl:when test="$paymentTypeCode = 'elv'">
                                            ...
                                            Der Rechnungsbetrag wird <xsl:value-of select="$sepaPreNotifyText"/> von Ihrem Konto <xsl:value-of select="$bankAccountData"/> per Lastschrift <xsl:value-of select="$clearingDate"/> eingezogen.
                                        </xsl:when>
